...
namespace CamCore
{
    ...
    public class Taylor4Model : RadialDistortionModel, IParameterizable
    {
       ...
       // private int _sxIdx { get { return 6; } }
        ...
        private double _k4 { get { return Parameters[_k4Idx]; } }
        ...
        List<AlgorithmParameter> _procParams;
        List<AlgorithmParameter> IParameterizable.Parameters
        {
        ...
        {
            Parameters[_k1Idx] = 0.0f;
            Parameters[_k2Idx] = 0.0f;
            Parameters[_k3Idx] = 0.0f;
            Parameters[_k4Idx] = 0.0f;
        ...
        {
            InitialAspectEstimation = AlgorithmParameter.FindValue<double>("ISX", _procParams);
            InitialCenterEstimation = new Vector2();
            InitialCenterEstimation.X = AlgorithmParameter.FindValue<double>("ICX", _procParams);
            InitialCenterEstimation.Y = AlgorithmParameter.FindValue<double>("ICY", _procParams);

            InitParameters();

            Parameters[_k1Idx] = AlgorithmParameter.FindValue<double>("IK1", _procParams);
