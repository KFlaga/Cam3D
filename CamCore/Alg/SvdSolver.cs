...
namespace CamCore
{
    ...
    {
        Matrix<double> _A;
        public Matrix<double> EquationsMatrix
        {
            set
            {
                _A = value;
    ...
    //public class SvdZeroSolver : ILinearEquationsSolver
    //{
    //    Matrix<double> _A;
    //    public Matrix<double> EquationsMatrix
    //    {
    ...
    //    Vector<double> _b;
    //    public Vector<double> RightSideVector // NOT USED
    //    {
    //        set
    //        {
    //            _b = value;
    ...
    //    {
    //        MathNet.Numerics.LinearAlgebra.Factorization.Svd<double> svd = A.Svd();
    //        return svd.VT.Column(svd.VT.ColumnCount - 1);
    //    }
    //}
