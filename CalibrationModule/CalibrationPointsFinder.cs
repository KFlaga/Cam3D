...
namespace CalibrationModule
{
    class CalibrationPointsFinder
    {
        ...
        public void FindCalibrationPoints()
        {
            ...
            foreach(CalibrationDot dot in _dots)
            {
                ...
                Points.Add(new CalibrationPoint() {
                    ImgX = (float)dot.Center.X,
                    ImgY = (float)dot.Center.Y
                });
            }
        }
        ...
        private void BinarizeImage()
        {
            ...
            binarizer.Image = Image;
            binarizer.Threshold = 0.5;
            binarizer.Inverse = true;
            Image = binarizer.ApplyFilter();
        }
