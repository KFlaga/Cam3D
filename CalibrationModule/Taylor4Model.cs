...
namespace CalibrationModule
{
    ...
    public class Taylor4Model : RadialDistortionModel, IParametrizedProcessor
    {
        ...
        void IParametrizedProcessor.InitParameters()
        {
            ...
            ProcessorParameter initalK4 = new ProcessorParameter(
                "Inital K4", "IK4",
                "System.Single", 0.0f, 100.0f, -100.0f);
        ...
        void IParametrizedProcessor.UpdateParameters()
        {
            ...
            Parameters[_k4Idx] = (float)ProcessorParameter.FindValue("IK3", _procParams);
        }
    }
}
