    ...
    public class CameraPair : INotifyPropertyChanged, IXmlSerializable
    {
        ...
        public Matrix<double> CameraLeft
        {
            ...
            set
            {
                ...
                UpdateCameraMatrix(_camLeft, SideIndex.Left);
                NotifyPropertyChanged("CameraLeft");
            }
        }
        ...
        public Matrix<double> CameraRight
        {
            ...
            set
            {
                ...
                UpdateCameraMatrix(_camRight, SideIndex.Right);
                NotifyPropertyChanged("CameraRight");
            }
        }
        ...
        {
            return idx == SideIndex.Left ? CameraLeft : CameraRight;
        }
        ...
        public Matrix<double> GetCalibrationMatrix(SideIndex idx)
        {
            return idx == SideIndex.Left ? CalibrationLeft : CalibrationRight;
        }

        public void SetCalibrationMatrix(SideIndex idx, Matrix<double> matrix)
        {
            if(idx == SideIndex.Left)
        ...
        public Matrix<double> GetRotationMatrix(SideIndex idx)
        {
            return idx == SideIndex.Left ? RotationLeft : RotationRight;
        }

        public void SetRotationMatrix(SideIndex idx, Matrix<double> matrix)
        {
            if(idx == SideIndex.Left)
                RotationLeft = matrix;
            else
        ...
        public Vector<double> GetTranslationVector(SideIndex idx)
        {
            return idx == SideIndex.Left ? TranslationLeft : TranslationRight;
        }

        public void SetTranslationVector(SideIndex idx, Vector<double> matrix)
        {
            if(idx == SideIndex.Left)
        ...
        public RadialDistortionModel GetDistortionModel(SideIndex idx)
        {
            return idx == SideIndex.Left ? DistortionModelLeft : DistortionModelRight;
        }

        public void SetDistortionModel(SideIndex idx, RadialDistortionModel model)
        {
            if(idx == SideIndex.Left)
        ...
        public void LoadFromFile(Stream file, string path)
        {
            ...
            else
            {
                ...
                {
                    IsCamLeftCalibrated = true;
                    CameraLeft = CamCore.XmlExtensions.MatrixFromNode(cam1.FirstChildWithName("Matrix"));
            ...
            else
            {
                ...
                {
                    IsCamRightCalibrated = true;
                    CameraRight = CamCore.XmlExtensions.MatrixFromNode(cam2.FirstChildWithName("Matrix"));
