...
namespace CamDX
{
    public class DX11Renderer : IDisposable
    {
        ...
        public DX11Scene CurrentScene { get; set; }
        ...
        public DX11Renderer(IntPtr windowHandle, Size2 size, Device dev = null)
        {
            ...
            else
            {
                ...
                Device.CreateWithSwapChain(DriverType.Hardware,
                   DeviceCreationFlags.BgraSupport, swapchainDesc, out _dxDevice, out _swapChain);
        ...
        public void Render()
        {
            _dxDevice.ImmediateContext.ClearDepthStencilView(_depthView, DepthStencilClearFlags.Depth, 1.0f, 0);
        ...
        public void Reset(int w, int h)
        {
            ...
            this.SetField(ref _depthView, new DepthStencilView(_dxDevice, _depthBuffer));

            // Setup targets and viewport for rendering
            _dxDevice.ImmediateContext.Rasterizer.SetViewport(
                new Viewport(0, 0, w, h, 0.0f, 1.0f));
            _dxDevice.ImmediateContext.OutputMerger.SetTargets(_depthView, _renderView);
        }
