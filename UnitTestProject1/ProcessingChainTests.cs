...
namespace UnitTestProject1
{
    ...
    public class ProcessingChainTests
    {
        ...
        public void TestCalibrationLink_Process()
        {
            ...
            Assert.IsTrue(_globalData.Get<CalibrationLinkData>().Calibration != null);
        ...
        public void TestCalibrationLink_LoadFromDisc()
        {
            ...
            Assert.IsTrue(_globalData.Get<CalibrationLinkData>().Calibration != null);
            Assert.IsTrue(_globalData.Get<CalibrationLinkData>().Calibration.CameraLeft != null);
            Assert.IsTrue(_globalData.Get<CalibrationLinkData>().Calibration.CameraRight != null);
        }
