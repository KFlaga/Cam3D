...
namespace CamUnitTest
{
    ...
    public class RaidalCorrectionMinimalisationTests
    {
        ...
        public void PrepareMinimalizationAlgorithm_JacobianTests()
        {
            ...
            _model.Parameters[0] = 2e-1; // k1
            _model.Parameters[1] = -1e-3; // k2
        ...
        public void Test_DistortionDirection()
        {
            ...
            for(int l = 0; l < _distLines.Count; ++l)
            {
                DistortionDirection dir =
                    _model.DirectionFromLine(_distLines[l],
                    fitCoeffs[l, 0], fitCoeffs[l, 1], fitCoeffs[l, 2]);
        ...
        public void Test_Compute_ABC_Ver3()
        {
            ...
            _model.Parameters[0] = 1e-2; // k1
            _model.Parameters[1] = -2e-3; // k2
            _model.Parameters[2] = 1e-4; // k3

            _distLines = DistortLines(_model, GenerateTestLines_Many());

            _model.Parameters[0] = 0; // k1
            _model.Parameters[1] = 0; // k2
            _model.Parameters[2] = 0; // k3
        ...
        public void PrepareMinimalizationAlgorithm_MinimalisationTests_Ver3()
        {
            ...
            _realModel.Parameters[0] = 0.2; // k1
            _realModel.Parameters[1] = -0.2; // k2
            _realModel.Parameters[2] = 0; // k3
            ...
            _realModel.Parameters.CopyTo(_realParameters);
        ...
        public void Test_Minimise_J3_Zero_R3_R3()
        {
            ...
            _model.Parameters[3] = 0.4;
            _model.Parameters[4] = 0.6;
            _model.Parameters[5] = 1.0;
            ...
            _miniAlg.BestResultVector.CopyTo(_model.Parameters);
        ...
        public void Test_Minimise_J3_Zero_R3_T4()
        {
            ...
            _model.Parameters[1] = 0.0;
            _model.Parameters[2] = 0.0;
            _model.Parameters[3] = 0.0;
            _model.Parameters[4] = 0.4;
            _model.Parameters[5] = 0.6;
